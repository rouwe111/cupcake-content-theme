        ...
        <section class="cc-company-logos-widget" <?php if ('' !== $title) : ?>aria-labelledby="<?php echo esc_attr($heading_id); ?>"<?php else : ?>aria-label="<?php echo esc_attr__('Companies', 'cupcake'); ?>"<?php endif; ?>>
            <?php if ('' !== $title || '' !== $subtitle) : ?>
                <header class="cc-company-logos-widget__header">
                    <?php if ('' !== $title) : ?>
                        <<?php echo esc_attr($title_tag); ?> id="<?php echo esc_attr($heading_id); ?>" class="cc-company-logos-widget__title<?php echo $title_style ? ' ' . esc_attr($title_style) : ''; ?>"><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
                    <?php endif; ?>
